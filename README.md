...
* **Compliance & Regulatory Suite (NIS 2, CIS Docker & Spanish ENS):** Native continuous compliance and technical audit engines for **CIS Docker Benchmark v1.6.0** (all 6 sections, Level 1 & Level 2 profiles, Posture Grade A–D; see [docs/cis-docker.md](docs/cis-docker.md)), **European NIS 2 Directive (EU 2022/2555)** (10 mandatory Article 21 risk-management controls, Essential vs. Important entity readiness scores; see [docs/nis2.md](docs/nis2.md)), and **Esquema Nacional de Seguridad (ENS RD 311/2022)** with 100% ALTO certification, tamper-evident SHA-256 chained forensic logging, mandatory TOTP MFA, real-time SIEM event forwarding, and AES-256-GCM encrypted backup schedules (see [docs/ens.md](docs/ens.md)).
