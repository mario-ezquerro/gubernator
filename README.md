...
* **eBPF Live Hub & Kernel Observability:** Non-invasive L4/L7 packet tracing, socket correlation, RTT latency & bandwidth metrics, and interactive service mesh topology (see [docs/ebpf.md](docs/ebpf.md)).
