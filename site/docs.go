...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/security.ISO27001Summary"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "security.ISO27001Control": {
            "type": "object",
            "properties": {
                "audit": {
                    "description": "Auditor verification procedure",
                    "type": "string"
                },
                "description": {
                ...
                "evidence": {
                    "description": "Real-time discovered cluster configuration",
                    "type": "string"
                },
                "id": {
                    "description": "e.g. \"A.5.15\", \"A.8.9\", \"A.8.24\"",
                    "type": "string"
                },
                "remediation": {
                    "description": "Prescriptive guidance to attain 100% compliance",
                    "type": "string"
                },
                "score": {
                ...
                "status": {
                    "description": "COMPLIANT, PARTIAL, NON_COMPLIANT",
                    "allOf": [
                        {
                            "$ref": "#/definitions/security.ISOStatus"
                        }
                    ]
                },
                "theme": {
                    "description": "ThemeA5Organizational or ThemeA8Technological",
                    "allOf": [
                        {
                            "$ref": "#/definitions/security.ISOTheme"
                        }
                    ]
                },
                "title": {
                    "description": "Formal ISO 27001:2022 title",
                    "type": "string"
                },
                "weight": {
                    "description": "Relative ponderation weight",
                    "type": "number"
                }
            }
        },
        "security.ISO27001Summary": {
            "type": "object",
            "properties": {
                "compliant_count": {
                    "type": "integer"
                ...
                "controls": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/security.ISO27001Control"
                    }
                },
                "evaluated_at": {
                    "type": "string"
        ...
        "security.ISOTheme": {
            ...
            "x-enum-varnames": [
                "ThemeA5Organizational",
                "ThemeA8Technological"
            ]
        }
    }
}`
