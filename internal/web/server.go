...
func StartDashboard() {
	...
	api := r.Group("/api", auth.RequireAuth())
	{
		...
		api.GET("/system/update/check", updateCheckHandler)
		api.GET("/update/status", updateStatusHandler)
		api.GET("/system/update/status", updateStatusHandler)
		...
		api.POST("/system/update/apply", auth.RequireRole(auth.RoleAdmin), updateApplyHandler)
