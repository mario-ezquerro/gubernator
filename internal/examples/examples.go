...
var catalog = []POCExample{
	...
	},
	{
		...
		Category:     "AI & Data Science",
		Description:  "Full-stack RAG pipeline with local LLM inference: PostgreSQL 16 + pgvector, Qdrant vector database, Ollama embedding & chat engine (nomic-embed-text + llama3.2), and Open-WebUI knowledge base interface.",
		Filename:     "pgvector-rag.yml",
		DefaultStack: "pgvector-rag",
		Services:     []string{"postgres-vector", "qdrant", "ollama-rag", "ollama-init", "rag-ui"},
		Icon:         "saved_search",
		Tags:         []string{"rag", "pgvector", "postgres", "qdrant", "vector", "ai", "embeddings", "ollama", "llm", "llama3"},
	},
	{
		ID:           "kafka-clickhouse",
