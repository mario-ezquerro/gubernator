...
class OverviewPage extends StatelessWidget {
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (n.memTotalBytes > 0 || n.cpuPercent > 0) ...[
                          const SizedBox(height: 10),
                          _buildNodeThermometers(theme, n),
                        ],
                      ],
                    ),
                  ),
  ...
  Widget _buildNodeThermometers(ThemeData theme, Node n) {
    ...
    String formatNetSpeed(double bytesPerSec) {
    ...
    Widget buildBar(String label, String valueText, double percent, Color defaultColor) {
    ...
    return Row(
      children: [
        buildBar('CPU', '${n.cpuPercent.toStringAsFixed(1)}%', n.cpuPercent, const Color(0xFF3B82F6)),
        const SizedBox(width: 12),
        buildBar('RAM', '${formatBytes(n.memUsedBytes)} / ${formatBytes(n.memTotalBytes)} (${n.memPercent.toStringAsFixed(1)}%)', n.memPercent, const Color(0xFF10B981)),
        const SizedBox(width: 12),
        Container(
