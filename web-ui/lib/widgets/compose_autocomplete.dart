...
class ComposeAutocomplete {
  static const List<ComposeSnippet> snippets = [
    ...
    ComposeSnippet(
      ...
      category: 'Resources',
      description: 'Set maximum CPU & RAM limits (prevent host starvation)',
      icon: Icons.speed,
      snippet: '    deploy:\n      resources:\n        limits:\n          cpus: "1.0"\n          memory: 512M\n',
    ),
    ComposeSnippet(
      label: 'deploy.resources.reservations',
      category: 'Resources',
      description: 'Set guaranteed minimum CPU & RAM reservations',
      icon: Icons.memory,
      snippet: '    deploy:\n      resources:\n        reservations:\n          cpus: "0.25"\n          memory: 128M\n',
    ),
    ComposeSnippet(
      label: 'resources.micro',
      category: 'Resources',
      description: 'Micro service preset (0.25 CPU / 128M RAM limit, 0.05 CPU / 32M RAM min)',
      icon: Icons.bolt,
      snippet: '    deploy:\n      resources:\n        limits:\n          cpus: "0.25"\n          memory: 128M\n        reservations:\n          cpus: "0.05"\n          memory: 32M\n',
    ),
    ComposeSnippet(
      label: 'resources.standard',
      category: 'Resources',
      description: 'Standard Web App preset (1.0 CPU / 512M RAM limit, 0.25 CPU / 128M RAM min)',
      icon: Icons.web,
      snippet: '    deploy:\n      resources:\n        limits:\n          cpus: "1.0"\n          memory: 512M\n        reservations:\n          cpus: "0.25"\n          memory: 128M\n',
    ),
    ComposeSnippet(
      ...
      category: 'Resources',
      description: 'Database / Cache preset (2.0 CPU / 2G RAM limit, 0.5 CPU / 512M RAM min)',
      icon: Icons.storage,
      snippet: '    deploy:\n      resources:\n        limits:\n          cpus: "2.0"\n          memory: 2G\n        reservations:\n          cpus: "0.5"\n          memory: 512M\n',
    ),
    ComposeSnippet(
      label: 'resources.datascience',
      category: 'Resources',
      description: 'Data Science / ML preset (4.0 CPU / 4G RAM limit, 1.0 CPU / 1G RAM min)',
      icon: Icons.science,
      snippet: '    deploy:\n      resources:\n        limits:\n          cpus: "4.0"\n          memory: 4G\n        reservations:\n          cpus: "1.0"\n          memory: 1G\n',
    ),
    ComposeSnippet(
      label: 'resources.ai_gpu',
      category: 'Resources',
      description: 'AI / LLM GPU model preset (4.0 CPU / 8G RAM limit, 2.0 CPU / 2G RAM min)',
